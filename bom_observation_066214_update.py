...
BOM_URL = "https://www.bom.gov.au/fwo/IDN60801/IDN60801.94768.json"
...
def append_log(refresh_message, observation):
    ...
    row = {
        ...
        "cloud_type_id": observation.get("cloud_type_id"),
        ...
        "press_tend": observation.get("press_tend"),
...
def build_readme(refresh_message, observation):
    ...
    table = f"""# BOM {STATION_NAME} Latest Observation
...
| WMO | {normalise_value(observation.get("wmo"))} |
...
| Pressure | {normalise_value(observation.get("press"))} hPa |
